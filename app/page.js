...
<section className="decisionHelper"><div className="decisionInner"><p className="eyebrow">SĀC ŠEIT</p><h2>Nezini, ar ko sākt?</h2><p className="decisionIntro">Atrodi sev tuvāko situāciju — mēs parādīsim, ar ko sākt.</p><div className="decisionList decisionScenarios"><a href="#proceduras"><div><strong>Āda ir sausa, jutīga vai blāva</strong><small>Sāc ar sejas procedūrām, kas palīdz uzlabot ādas komfortu, mitrumu un kopējo izskatu.</small></div><b>→</b></a><a href="#first-visit"><div><strong>Akne, poras vai nevienmērīga ādas tekstūra</strong><small>Sāc ar konsultāciju, lai speciāliste var izvērtēt ādas stāvokli un piemeklēt piemērotu risinājumu.</small></div><b>→</b></a><a href="/endosfera"><div><strong>Vēlos uzlabot ķermeņa aprises vai tonusu</strong><small>Apskati ķermeņa procedūras un Endosfēras terapiju.</small></div><b>→</b></a><a href="#first-visit"><div><strong>Nezinu, kas man būtu piemērots</strong><small>Pirmā vizīte palīdzēs saprast vajadzības un izvēlēties nākamo soli.</small></div><b>→</b></a></div></div></section>
