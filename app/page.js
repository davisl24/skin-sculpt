...
<section className="decisionHelper"><div className="decisionInner"><p className="eyebrow">SĀC ŠEIT</p><h2>Nezini, ar ko sākt?</h2><p className="decisionIntro">Izvēlies savu vajadzību vai piesakies konsultācijai — mēs palīdzēsim atrast piemērotāko nākamo soli.</p><div className="decisionList"><a href="#proceduras"><span className="decisionIcon">◯</span><div><strong>Sejas āda</strong><small>Skaistāka, veselīgāka un mirdzošāka āda</small></div><b>→</b></a><a href="#proceduras"><span className="decisionIcon">◯</span><div><strong>Ķermenis</strong><small>Tvirtākas aprises un labāka pašsajūta</small></div><b>→</b></a><a href="#first-visit"><span className="decisionIcon">◯</span><div><strong>Neesmu pārliecināta</strong><small>Pirmā vizīte / konsultācija</small></div><b>→</b></a></div></div></section>
